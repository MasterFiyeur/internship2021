	...
	<main class="hoc container clear"> 
		...
		<section class="group shout">
			<figure class="one_half first"><img src="images/dictionary.jpg" alt="Dictionary">
				<figcaption class="heading"><a href="./pages/about.php"><?php echo $lang["navbar"]["about"]; ?></a></figcaption>
			</figure>
			<figure class="one_half"><img src="images/authors.jpg" alt="Authors">
				<figcaption class="heading"><a href="./pages/authors.php"><?php echo $lang["navbar"]["authors"]; ?></a></figcaption>
			</figure>
		</section>
		<!-- / main body -->
		<div class="clear"></div>
