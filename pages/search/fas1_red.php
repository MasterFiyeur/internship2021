	...
	<div class="bgded overlay" style="background-image:url('../../images/associativnoe-myshlenie.jpg');">
		<div id="breadcrumb" class="hoc clear">
			<ul>
				...
				<li><a href="../dict_fas1_red.php"><?php echo $lang["dict"]["fas1_red"]; ?></a></li>
				<?php
		...
		<main class="hoc container clear">
			...
			<div class="sidebar one_quarter first">
				<nav class="sdb_holder">
					<ul>
						<li><a href="../dict_fas1_red.php#about"><?php echo $lang["dict"]["about_title"]; ?></a></li>
						<li><a href="../dict_fas1_red.php#stim"><?php echo $lang["dict"]["stim_title"]; ?></a></li>
			...
			<div class="content three_quarter">
				...
				<div id="result">
					...
					<input type="hidden" id="dictionary" value="fas1_red">
				</div>
			</div>
			<!-- / main body -->
			<div class="clear"></div>
