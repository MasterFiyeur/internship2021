		...
		<main class="hoc container clear">
			...
			<div class="sidebar one_quarter first">
				<nav class="sdb_holder">
					<ul>
						<li><a href="../dict_sanfn.php#about"><?php echo $lang->dict->about_title->{$_SESSION["lang"]}; ?></a></li>
						<li><a href="../dict_sanfn.php#stim"><?php echo $lang->dict->stim_title->{$_SESSION["lang"]}; ?></a></li>
